"""Slow reference (CPU/PyTorch) implementation of the scattering renderer.

The primary pipeline uses the CUDA extension (`scatter_cuda`) for performance.
This file exists as a readable reference and as a fallback when CUDA is not used.
"""
import os
